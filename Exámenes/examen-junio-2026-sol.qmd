...
subtitle: "Junio de 2026. Soluciones"
format: 
    pdf:
        fontsize: 14pt
        include-in-header: 
...
Se pide modelar esta estructura con clases en Python, incluyendo una clase Flota que almacene una lista de vehículos. La clase Flota debe tener un método llamado generar_informe_consumos() que sea una función generadora. Este método debe iterar sobre los vehículos y entregar (yield), uno a uno, el consumo total de cada vehículo.

**Puntuación:** Se valorará con 1.5 puntos si la solución no usa funciones generadoras. Se valorará con 3 puntos si utiliza correctamente yield y anotaciones de tipos (type hints).
...
Dada la siguiente función que filtra números mayores a 10 y les aplica un impuesto del 21%, modifíquela para que realice exactamente lo mismo utilizando una list comprehension (lista por comprensión) en una sola línea.
